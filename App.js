...
const LOCALES = {
  ...
  es: {
    ...
    startBtn: 'Empezar',
    onboardingSteps: [
      { title: '¡Bienvenido a PortuStart! 🇵🇹', desc: 'Tu compañero digital para una mudanza fluida y sin estrés a Portugal.' },
      { title: '1. Servicios oficiales y hoja de ruta 📄', desc: 'Gestiona NIF, cuenta bancaria, NISS y seguro médico de forma digital y sigue tus primeros 30 días.' },
      { title: '2. Explora Portugal 🗺', desc: 'Encuentra los mejores lugares y playas y reserva tours con nuestros socios.' },
      { title: '3. Cajeros y médicos de emergencia 🏧🩺', desc: 'Localiza cajeros Multibanco sin comisiones y médicos de habla inglesa.' },
      { title: '4. Ofertas exclusivas para expatriados 🔥', desc: 'Ahorra dinero con socios oficiales como Revolut, e-Residence e italki.' },
      { title: '5. Traductor y calculadora de salario 🗣💶', desc: 'Traduce sobre la marcha con STT/TTS y calcula tu salario neto en Portugal.' },
    ],
    from: 'De:',
    to: 'A:',
    inputLabel: 'Entrada:',
  ...
  fr: {
    ...
    startBtn: 'Commencer',
    onboardingSteps: [
      { title: 'Bienvenue sur PortuStart ! 🇵🇹', desc: 'Votre compagnon numérique pour une installation fluide et sans stress au Portugal.' },
      { title: '1. Services officiels et Roadmap 📄', desc: 'Gérez NIF, compte bancaire, NISS et assurance santé numériquement et suivez vos 30 premiers jours.' },
      { title: '2. Explorez le Portugal 🗺', desc: 'Trouvez les plus beaux sites, plages et réservez des excursions via nos partenaires.' },
      { title: '3. DAB et Médecins d’urgence 🏧🩺', desc: 'Localisez les distributeurs Multibanco sans frais et des médecins anglophones.' },
      { title: '4. Offres exclusives Expat 🔥', desc: 'Économisez de l’argent grâce à nos partenaires officiels comme Revolut, e-Residence et italki.' },
      { title: '5. Traducteur et Calculateur de salaire 🗣💶', desc: 'Traduisez sur place avec STT/TTS et estimez votre salaire net au Portugal.' },
    ],
    from: 'De :',
    to: 'Vers :',
    inputLabel: 'Saisie :',
  ...
  it: {
    ...
    startBtn: 'Inizia',
    onboardingSteps: [
      { title: 'Benvenuto su PortuStart! 🇵🇹', desc: 'Il tuo compagno digitale per un trasferimento in Portogallo semplice e senza stress.' },
      { title: '1. Servizi ufficiali e Roadmap 📄', desc: 'Gestisci NIF, conto bancario, NISS e assicurazione sanitaria digitalmente e segui i tuoi primi 30 giorni.' },
      { title: '2. Esplora il Portogallo 🗺', desc: 'Trova i luoghi imperdibili, le spiagge e prenota tour direttamente con i nostri partner.' },
      { title: '3. Bancomat e Medici d’emergenza 🏧🩺', desc: 'Trova bancomat Multibanco senza commissioni e medici di lingua inglese vicini a te.' },
      { title: '4. Offerte esclusive Expat 🔥', desc: 'Risparmia denaro con i nostri partner ufficiali come Revolut, e-Residence e italki.' },
      { title: '5. Traduttore e Calcolatore di stipendio 🗣💶', desc: 'Traduci sul posto con STT/TTS e stima il tuo stipendio netto in Portogallo.' },
    ],
    from: 'Da:',
    to: 'A:',
    ...
    cities: [
      ...
      },
      {
        ...
        places: [
          ...
          { id: 'mb2', title: 'Spiaggia di Calheta', category: '🏖 Laguna dorada', desc: 'Spiaggia gemella protetta con acque calme.', tip: 'Consiglio: Ideale per famiglie.' },
        ],
      },
    ],
  },
