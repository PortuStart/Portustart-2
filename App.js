    ...
    cities: [
      {
        ...
        places: [
          ...
          { id: 'l3', title: 'Площа Коммерсіу', category: 'Історична площа', desc: 'Велична річкова площа з аркадами.', tip: 'Порада: Чудова початкова точка для прогулянок.' },
      ...
      },
      {
        ...
        places: [
          ...
          { id: 'pb1', title: 'Пляж Матозіньюш', category: '🏖 Пляж біля метро', desc: 'Широкий пляж на кінцевій зупинці метро, відомий морепродуктами.', tip: 'Порада: Спробуйте смаμаного сібаса.' },
