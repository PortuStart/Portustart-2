...
const LOCALES = {
  ...
  es: {
    ...
    tabTrans: 'Traductor',
    tabCalc: 'Salario',
    placesSectionTitle: '🇵🇹 Mapa interactivo y lugares de interés',
    placesSectionSub: 'Mapa en vivo de Portugal – elige una región o reserva excursiones:',
    openInAppMaps: 'Abrir en Mapas',
    swipeInstruction: '👉 Desliza horizontalmente para ver lugares, playas y excursiones:',
    openInMapsBtn: 'Ruta',
    gygBtn: 'Entradas y Excursiones (GetYourGuide) ↗',
    italkiBannerTitle: '🗣 Aprende a hablar portugués con fluidez',
    italkiBannerDesc: 'Encuentra profesores nativos certificados para clases en línea 1 a 1 en italki.',
    italkiBtn: 'Buscar profesores (italki) ↗',
    
    atmSectionTitle: '🏧 Cajeros sin comisiones (Multibanco)',
    atmSectionSub: 'Utiliza la red oficial de Multibanco en sucursales bancarias para retirar efectivo con Revolut o Wise sin recargos:',
    atmTipTitle: '💡 Consejo importante para expatriados:',
    atmTipDesc: 'Elige siempre que te cobren en Euros (€) si el cajero te ofrece conversión a tu moneda local.',

    docSectionTitle: '🩺 Médicos de habla inglesa y emergencias',
    docSectionSub: 'Líneas de emergencia esenciales y centros médicos privados con atención internacional:',
    callDoctorBtn: 'Llamar',
    directionBtn: 'Abrir ubicación',
    emergencyTitle: '🚨 Contactos de emergencia y apoyo',

    perksSectionTitle: '🔥 Ofertas y ventajas exclusivas',
    perksSectionSub: 'Ahorra tiempo y dinero con nuestros socios oficiales usando tus beneficios de PortuStart:',
    claimDealBtn: 'Reclamar oferta ↗',

    perk1Title: 'Cuenta Expat Revolut',
    perk1Badge: 'Finanzas • Sin comisiones',
    perk1Desc: '• Cero comisiones en moneda extranjera\n• Incluye tarjeta Visa física\n• Ideal para alquiler y salario en PT',

    perk2Title: 'e-Residence NIF Express',
    perk2Badge: 'Gobierno • Entrega en 48h',
    perk2Desc: '• Sin necesidad de ir a Finanças en persona\n• 100% digital y legalmente válido\n• Incluye firma digital segura',

    perk3Title: 'Clases de idiomas italki',
    perk3Badge: 'Idiomas • 1 a 1',
    perk3Desc: '• Profesores nativos certificados de portugués\n• Horarios flexibles en línea\n• Ideal para comunicación diaria y oficial',

    congratsTitle: '🎉 ¡Felicitaciones!',
    congratsDesc: '¡Has completado con éxito los 7 pasos de tu hoja de ruta! Estás listo para tu nuevo comienzo perfecto en Portugal.',
    ...
    servicesSub: 'Solicita documentos esenciales y cobertura 100% online a través de nuestro socio e-Residence:',
    checklistTitle: '📋 Hoja de ruta de los primeros 30 días',
    checklistSub: 'Tu lista de verificación de reubicación paso a paso',
    checklistDone: 'completado',
    applyOnlineBtn: 'Solicitar online ahora ↗',
    affiliateDisclosure: 'Aviso de transparencia: Estos enlaces dirigen a un procesamiento exprés certificado con e-Residence. Recibimos una pequeña comisión sin costo adicional para ti.',
    affiliateCards: [
      { key: 'nif', title: 'NIF (Número de Identificación Fiscal)', badge: 'Paso 1 • Esencial', desc: 'La llave maestra para alquileres, tarjetas SIM, empleo y bancos.', link: AFFILIATE_LINKS.eResidenceNif, icon: 'document-text' },
      { key: 'bank', title: 'Cuenta bancaria portuguesa', badge: 'Paso 2 • IBAN', desc: 'Abre una cuenta bancaria local con IBAN portugués.', link: AFFILIATE_LINKS.eResidenceBank, icon: 'card' },
      { key: 'niss', title: 'NISS (Número de la Seguridad Social)', badge: 'Paso 3 • Empleo', desc: 'Obligatorio para la nómina y contratos de trabajo.', link: AFFILIATE_LINKS.eResidenceNiss, icon: 'shield-checkmark' },
      { key: 'health', title: 'Seguro médico internacional para expatriados', badge: 'Paso 4 • Visado y salud', desc: 'Cobertura médica requerida para visados de nómadas D7/D8.', link: AFFILIATE_LINKS.eResidenceHealth, icon: 'medkit' },
    ],
    ...
    calc14Notice: 'Basado en 14 pagas estándar al año',
    calcGrossRow: 'Bruto mensual:',
    calcSSRow: 'Seguridad Social (-11%):',
    calcIRSRow: 'Retención IRS:',
    checklist: [
      { id: 1, title: 'Obtener tu número fiscal (NIF)', tip: 'La clave para alquileres, tarjeta SIM, empleo y servicios.' },
      { id: 2, title: 'Conseguir una tarjeta SIM local portuguesa', tip: 'Esencial para la autenticación digital del gobierno (Chave Móvel).' },
      { id: 3, title: 'Abrir una cuenta bancaria portuguesa', tip: 'Requerido para el pago de salarios y depósitos de alquiler.' },
      { id: 4, title: 'Contratar seguro médico para expatriados', tip: 'Esencial para el visado y atención médica previa al SNS.' },
      { id: 5, title: 'Obtener el número de la Seguridad Social (NISS)', tip: 'Obligatorio para cotizaciones laborales y de pensiones.' },
      { id: 6, title: 'Registro de residencia (CRUE / AIMA)', tip: 'Los ciudadanos de la UE se registran en el ayuntamiento tras 3 meses.' },
      { id: 7, title: 'Obtener tu número de salud SNS', tip: 'Otorga acceso a centros de salud pública (Centro de Saúde).' },
    ],
    cities: [
      {
        id: 'lisboa',
        name: 'Lisboa',
        tagline: 'Ciudad de 7 colinas, Fado y miradores panorámicos',
        places: [
          { id: 'l1', title: 'Torre de Belém y Monasterio de los Jerónimos', category: 'Patrimonio de la Humanidad', desc: 'Obra maestra manuelina a orillas del Tajo.', tip: 'Consejo: Llegar antes de las 10:00.' },
          { id: 'l2', title: 'Mirador de Santa Luzia', category: 'Mirador', desc: 'Buganvillas con vistas a los tejados de terracota.', tip: 'Consejo: Visitar al atardecer.' },
          { id: 'l3', title: 'Plaza del Comercio', category: 'Plaza histórica', desc: 'Gran plaza porticada abierta hacia el río.', tip: 'Consejo: Excelente punto de partida para pasear.' },
          { id: 'lb1', title: 'Playa de Carcavelos', category: '🏖 Playa urbana y de surf', desc: 'La mayor playa en la línea de tren de Cascais.', tip: 'Consejo: 25 min en tren desde Cais do Sodré.' },
      ...
      },
      {
        ...
        places: [
          { id: 'p1', title: 'Puente Don Luis I y Ribeira', category: 'Monumento', desc: 'Icónico puente de hierro de doble piso sobre el Duero.', tip: 'Consejo: Cruza por la plataforma superior.' },
          { id: 'p2', title: 'Librería Lello', category: 'Arquitectura', desc: 'Famosa librería neogótica con escalera roja.', tip: 'Consejo: Reserva entradas online.' },
          { id: 'p3', title: 'Bodegas de vino de Oporto en Gaia', category: 'Degustación y tradición', desc: 'Bodegas centenarias con barcos tradicionales.', tip: 'Consejo: Reserva una cata guiada.' },
          { id: 'pb1', title: 'Playa de Matosinhos', category: '🏖 Playa de metro', desc: 'Amplia playa junto al metro, famosa por sus mariscos.', tip: 'Consejo: Prueba la lubina a la parrilla.' },
          { id: 'pb2', title: 'Playa de Miramar', category: '🏖 Capilla en el mar', desc: 'Capilla del siglo XVII sobre rocas en el océano.', tip: 'Consejo: Excelente para fotos al atardecer.' },
        ],
      },
      {
        id: 'sintra',
        name: 'Sintra y Cascais',
        tagline: 'Palacios de cuento en bosques nublados y acantilados',
        places: [
          { id: 's1', title: 'Palacio Nacional de la Pena', category: 'Palacio romántico', desc: 'Castillo colorido en las cumbres más altas de Sintra.', tip: 'Consejo: Reserva turnos de mañana.' },
          ...
          { id: 's3', title: 'Cabo da Roca', category: 'Maravilla natural', desc: 'El punto más occidental de la Europa continental.', tip: 'Consejo: Lleva cortavientos.' },
          { id: 'sb1', title: 'Playa de Guincho', category: '🏖 Dunas y surf salvaje', desc: 'Paraíso del surf rodeado de dunas.', tip: 'Consejo: Usa las pasarelas de madera.' },
          { id: 'sb2', title: 'Playa de Ursa', category: '🏖 Cala secreta', desc: 'Playa salvaje rodeada de formaciones rocosas.', tip: 'Consejo: Usa calzado de senderismo.' },
        ],
      },
      {
        id: 'algarve',
        ...
        places: [
          { id: 'a1', title: 'Cueva marina de Benagil', category: 'Cuevas y playas', desc: 'La cueva catedral marina más famosa de Europa.', tip: 'Consejo: Alquila un kayak temprano.' },
          { id: 'a2', title: 'Ponta da Piedade (Lagos)', category: 'Costa de acantilados', desc: 'Arcos de piedra caliza y aguas turquesas.', tip: 'Consejo: Haz un tour en barco pequeño.' },
          { id: 'a3', title: 'Parque Natural de la Ría Formosa', category: 'Laguna e islas', desc: 'Humedal protegido con islas libres de coches.', tip: 'Consejo: Toma el ferry a Armona.' },
          { id: 'ab1', title: 'Playa de Marinha', category: '🏖 Top playa europea', desc: 'Arcos dobles de piedra y aguas cristalinas.', tip: 'Consejo: Sendero de los Siete Valles Colgantes.' },
          { id: 'ab2', title: 'Playa de la Falesia', category: '🏖 Acantilados rojos', desc: 'Más de 6 km de arena bajo acantilados rojizos.', tip: 'Consejo: Paseos con marea baja.' },
        ],
      },
      {
        id: 'coimbra',
        ...
        places: [
          { id: 'c1', title: 'Biblioteca Joanina', category: 'Biblioteca barroca', desc: 'Biblioteca dorada con manuscritos históricos raros.', tip: 'Consejo: Reserva entradas combinadas.' },
          { id: 'c2', title: 'Monasterio de Santa Cruz', category: 'Historia y fado', desc: 'Lugar de descanso de los primeros reyes de Portugal.', tip: 'Consejo: Escucha fado por la noche.' },
          { id: 'cb1', title: 'Playa de la Claridade (Figueira)', category: '🏖 Gran playa de arena', desc: 'Inmensa playa con pasarelas de madera.', tip: 'Consejo: 40 min en tren.' },
          { id: 'cb2', title: 'Playa de Mira', category: '🏖 Pesca tradicional', desc: 'Pintoresca playa con casetas de madera a rayas.', tip: 'Consejo: Prueba los calamares fritos.' },
        ],
      },
      {
        id: 'madeira',
        name: 'Madeira (Funchal)',
        tagline: 'La isla de las flores, picos escarpados y levadas',
        places: [
          { id: 'm1', title: 'Pico do Arieiro a Pico Ruivo', category: 'Ruta alpina', desc: 'Travesía por crestas montañosas sobre las nubes.', tip: 'Consejo: Ve a ver el amanecer.' },
          { id: 'm2', title: 'Ruta de las 25 Fuentes', category: 'Naturaleza UNESCO', desc: 'Sendero de canales a través de un bosque de laurisilva.', tip: 'Consejo: Empieza temprano.' },
          { id: 'mb1', title: 'Prainha do Caniçal', category: '🏖 Playa de arena negra', desc: 'Encantadora cala natural de arena volcánica oscura.', tip: 'Consejo: Hermoso contraste de colores.' },
          { id: 'mb2', title: 'Playa de Calheta', category: '🏖 Laguna dorada', desc: 'Playa gemela protegida con aguas tranquilas.', tip: 'Consejo: Ideal para familias.' },
        ],
      },
    ],
  },
  fr: {
    ...
    tabTrans: 'Traducteur',
    tabCalc: 'Salaire',
    placesSectionTitle: '🇵🇹 Carte interactive et sites incontournables',
    placesSectionSub: 'Carte en direct du Portugal – choisissez une région ou réservez des excursions :',
    openInAppMaps: 'Ouvrir dans Plans',
    swipeInstruction: '👉 Glissez horizontalement pour voir les sites, plages et excursions :',
    openInMapsBtn: 'Itinéraire',
    gygBtn: 'Billets & Excursions (GetYourGuide) ↗',
    italkiBannerTitle: '🗣 Apprenez à parler couramment le portugais',
    italkiBannerDesc: 'Trouvez des tuteurs natifs certifiés pour des cours en ligne 1 à 1 sur italki.',
    ...
    atmTipTitle: '💡 Conseil important pour expatriés :',
    atmTipDesc: 'Choisissez toujours d’être facturé en Euros (€) si le distributeur propose une conversion dans votre devise d’origine.',

    docSectionTitle: '🩺 Médecins anglophones et urgences',
    docSectionSub: 'Numéros d’urgence essentiels et centres médicaux privés avec assistance internationale :',
    callDoctorBtn: 'Appeler',
    directionBtn: 'Ouvrir le lieu',
    emergencyTitle: '🚨 Contacts d’urgence et d’assistance',

    perksSectionTitle: '🔥 Offres et avantages exclusifs',
    perksSectionSub: 'Économisez du temps et de l’argent avec nos partenaires officiels grâce à vos avantages PortuStart :',
    claimDealBtn: 'Profiter de l’offre ↗',

    perk1Title: 'Compte Expat Revolut',
    perk1Badge: 'Finance • Sans frais',
    perk1Desc: '• Zéro frais de change à l’étranger\n• Carte Visa physique incluse\n• Idéal pour le loyer et le salaire au PT',

    perk2Title: 'e-Residence NIF Express',
    perk2Badge: 'Gouvernement • Livraison 48h',
    perk2Desc: '• Aucun déplacement physique aux Finanças\n• 100% numérique et juridiquement valide\n• Signature numérique sécurisée incluse',

    perk3Title: 'Cours de langues italki',
    perk3Badge: 'Langues • 1 à 1',
    perk3Desc: '• Professeurs natifs certifiés de portugais\n• Horaires en ligne flexibles\n• Idéal pour la communication quotidienne et officielle',
    ...
    servicesSub: 'Commandez vos documents essentiels et votre couverture 100% en ligne via notre partenaire e-Residence :',
    checklistTitle: '📋 Feuille de route des 30 premiers jours',
    checklistSub: 'Votre liste de contrôle de relocalisation étape par étape',
    checklistDone: 'terminé',
    applyOnlineBtn: 'Demander en ligne ↗',
    affiliateDisclosure: 'Avis de transparence : Ces liens mènent vers un traitement express certifié avec e-Residence. Nous recevons une petite commission sans frais supplémentaires pour vous.',
    affiliateCards: [
      { key: 'nif', title: 'NIF (Numéro d’identification fiscale portugais)', badge: 'Étape 1 • Essentiel', desc: 'La clé pour louer, obtenir une carte SIM, un emploi et un compte bancaire.', link: AFFILIATE_LINKS.eResidenceNif, icon: 'document-text' },
      { key: 'bank', title: 'Compte bancaire portugais', badge: 'Étape 2 • IBAN', desc: 'Ouvrez un compte bancaire local conforme avec IBAN portugais.', link: AFFILIATE_LINKS.eResidenceBank, icon: 'card' },
      { key: 'niss', title: 'NISS (Numéro de sécurité sociale)', badge: 'Étape 3 • Emploi', desc: 'Obligatoire pour la paie et les contrats de travail.', link: AFFILIATE_LINKS.eResidenceNiss, icon: 'shield-checkmark' },
      { key: 'health', title: 'Assurance santé internationale pour expatriés', badge: 'Étape 4 • Visa et soins', desc: 'Couverture médicale obligatoire pour les visas nomades D7/D8.', link: AFFILIATE_LINKS.eResidenceHealth, icon: 'medkit' },
    ],
    calcTitle: '💶 Calculateur de salaire net',
    calcSub: 'Employé célibataire, Portugal continental (14 versements).',
    calcGrossLabel: 'Salaire brut mensuel (€) :',
    calcBtn: 'Calculer',
    calcNetMonthly: 'Net estimé (mensuel) :',
    calc14Notice: 'Basé sur 14 versements standards / an',
    ...
    checklist: [
      ...
      { id: 2, title: 'Obtenir une carte SIM portugaise locale', tip: 'Essentiel pour l’authentification numérique (Chave Móvel).' },
      { id: 3, title: 'Ouvrir un compte bancaire portugais', tip: 'Requis pour le versement du salaire et la caution de loyer.' },
      { id: 4, title: 'Souscrire une assurance santé exxpatiée', tip: 'Essentiel pour le visa et les soins avant l’obtention du SNS.' },
      { id: 5, title: 'Obtenir le numéro de sécurité sociale (NISS)', tip: 'Obligatoire pour les cotisations salariales et de retraite.' },
      { id: 6, title: 'Enregistrement de résidence (CRUE / AIMA)', tip: 'Les citoyens de l’UE s’enregistrent à la mairie (Câmara) après 3 mois.' },
      { id: 7, title: 'Obtenir votre numéro de santé SNS', tip: 'Donne accès aux centres de soins de santé primaires publics (Centro de Saúde).' },
    ],
    cities: [
      {
        id: 'lisboa',
        name: 'Lisbonne',
        tagline: 'La ville aux 7 collines, au Fado et aux panoramas',
        places: [
          { id: 'l1', title: 'Tour de Belém & Monastère des Hiéronymites', category: 'Patrimoine mondial de l’UNESCO', desc: 'Chef-d’œuvre manuélin le long du Tage.', tip: 'Conseil : Arriver avant 10h00.' },
          { id: 'l2', title: 'Miradouro de Santa Luzia', category: 'Belvédère', desc: 'Bougainvilliers surplombant les toits de terre cuite.', tip: 'Conseil : À visiter au coucher du soleil.' },
          { id: 'l3', title: 'Praça do Comércio', category: 'Place historique', desc: 'Grande place royale ouverte sur le fleuve.', tip: 'Conseil : Excellent point de départ pour une promenade.' },
          { id: 'lb1', title: 'Plage de Carcavelos', category: '🏖 Plage urbaine et de surf', desc: 'La plus grande plage sur la ligne de train de Cascais.', tip: 'Conseil : 25 min de train depuis Cais do Sodré.' },
          { id: 'lb2', title: 'Plage des Galapinhos', category: '🏖 Nature d’Arrábida', desc: 'Eaux cristallines sous les falaises du parc naturel.', tip: 'Conseil : Arriver tôt en été.' },
        ],
      },
      {
        id: 'porto',
        name: 'Porto',
        tagline: 'Architecture en granit, vin de Porto et ponts spectaculaires',
        places: [
          { id: 'p1', title: 'Pont Dom Luís I & Ribeira', category: 'Monument', desc: 'Pont en arc en fer à double tablier sur le Douro.', tip: 'Conseil : Empruntez le tablier supérieur à pied.' },
          { id: 'p2', title: 'Librairie Lello', category: 'Architecture', desc: 'Célèbre librairie néogothique avec son escalier rouge.', tip: 'Conseil : Réservez vos billets en ligne.' },
          { id: 'p3', title: 'Caves de vin de Porto à Gaia', category: 'Dégustation et patrimoine', desc: 'Caves centenaires avec bateaux traditionnels.', tip: 'Conseil : Réservez une dégustation guidée.' },
          { id: 'pb1', title: 'Plage de Matosinhos', category: '🏖 Plage de métro', desc: 'Large plage au terminus du métro, réputée pour ses fruits de mer.', tip: 'Conseil : Goûtez le bar grillé.' },
          { id: 'pb2', title: 'Plage de Miramar', category: '🏖 Chapelle sur l’océan', desc: 'Chapelle du XVIIe siècle perchée sur des rochers marins.', tip: 'Conseil : Superbe spot photo au coucher du soleil.' },
        ],
      },
      {
        id: 'sintra',
        name: 'Sintra & Cascais',
        tagline: 'Palais de conte de fées dans les forêts brumeuses et falaises',
        places: [
          { id: 's1', title: 'Palais national de Pena', category: 'Palais romantique', desc: 'Château coloré sur les hauteurs de Sintra.', tip: 'Conseil : Réservez des créneaux matinaux.' },
          { id: 's2', title: 'Quinta da Regaleira', category: 'Domaine mystique', desc: 'Parc enchanté avec grottes et Puits d’Initiation.', tip: 'Conseil : Apportez une lampe torche.' },
          { id: 's3', title: 'Cabo da Roca', category: 'Merveille naturelle', desc: 'Le point le plus occidental de l’Europe continentale.', tip: 'Conseil : Prévoyez un coupe-vent.' },
          { id: 'sb1', title: 'Plage du Guincho', category: '🏖 Dunes et surf sauvage', desc: 'Refuge de surf mondialement connu entouré de dunes.', tip: 'Conseil : Empruntez les passerelles en bois.' },
          { id: 'sb2', title: 'Plage de l’Ours (Ursa)', category: '🏖 Crique secrète', desc: 'Plage sauvage isolée flanquée d’immenses rochers.', tip: 'Conseil : Portez des chaussures de marche.' },
        ],
      },
      {
        id: 'algarve',
        name: 'Faro & Algarve',
        tagline: 'Falaises dorées et 300 jours de soleil par an',
        places: [
          { id: 'a1', title: 'Grotte marine de Benagil', category: 'Grottes et plages', desc: 'La cathédrale marine sculptée par les vagues la plus célèbre.', tip: 'Conseil : Louez un kayak tôt le matin.' },
          { id: 'a2', title: 'Ponta da Piedade (Lagos)', category: 'Côte rocheuse', desc: 'Arches en calcaire et eaux turquoise limpides.', tip: 'Conseil : Faites une petite excursion en bateau.' },
          { id: 'a3', title: 'Parc naturel de Ria Formosa', category: 'Lagune et îles', desc: 'Zone humide côtière protégée avec îles piétonnes.', tip: 'Conseil : Prenez le ferry pour Armona.' },
          { id: 'ab1', title: 'Plage de Marinha', category: '🏖 Top plage européenne', desc: 'Arches doubles emblématiques et eaux de snorkeling.', tip: 'Conseil : Sentier des Sept Vallées Suspendues.' },
          { id: 'ab2', title: 'Plage de la Falesia', category: '🏖 Falaises rouges', desc: 'Plus de 6 km de sable abrités par des falaises de grès rouge.', tip: 'Conseil : Promenades à marée basse.' },
        ],
      },
      {
        id: 'coimbra',
        ...
        places: [
          { id: 'c1', title: 'Bibliothèque Joanina', category: 'Bibliothèque baroque', desc: 'Bibliothèque dorée abritant des manuscrits rares.', tip: 'Conseil : Réservez des billets combinés.' },
          { id: 'c2', title: 'Monastère de Santa Cruz', category: 'Histoire et fado', desc: 'Lieu de repos des premiers rois du Portugal.', tip: 'Conseil : Assistez à un concert de fado en soirée.' },
          { id: 'cb1', title: 'Plage de la Claridade (Figueira)', category: '🏖 Immense plage de sable', desc: 'Vaste étendue de sable équipée de passerelles.', tip: 'Conseil : 40 min de train depuis Coimbra.' },
          { id: 'cb2', title: 'Plage de Mira', category: '🏖 Pêche traditionnelle', desc: 'Plage pittoresque avec cabanes en bois rayées.', tip: 'Conseil : Goûtez les calamars frits.' },
        ],
      },
      {
        id: 'madeira',
        name: 'Madère (Funchal)',
        tagline: 'L’île aux fleurs aux sommets escarpés et levadas luxuriantes',
        places: [
          { id: 'm1', title: 'Pico do Arieiro au Pico Ruivo', category: 'Sentier alpin', desc: 'Traversée de crêtes montagneuses au-dessus des nuages.', tip: 'Conseil : Partez pour admirer le lever du soleil.' },
          { id: 'm2', title: 'Randonnée des 25 Fontes', category: 'Nature UNESCO', desc: 'Sentier le long de canaux historiques en forêt de lauriers.', tip: 'Conseil : Partez tôt le matin.' },
          { id: 'mb1', title: 'Prainha do Caniçal', category: '🏖 Plage de sable noir', desc: 'Charmante crique naturelle de sable volcanique sombre.', tip: 'Conseil : Superbe contraste de couleurs.' },
          { id: 'mb2', title: 'Plage de Calheta', category: '🏖 Lagon doré', desc: 'Plage jumelle protégée aux eaux calmes et chaudes.', tip: 'Conseil : Idéal pour les familles.' },
        ],
      },
    ],
  },
  it: {
    ...
    tabTrans: 'Traduttore',
    tabCalc: 'Stipendio',
    placesSectionTitle: '🇵🇹 Mappa interattiva e luoghi d’interesse',
    ...
    italkiBannerTitle: '🗣 Impara a parlare fluentemente il portoghese',
    italkiBannerDesc: 'Trova tutor madrelingua certificati per lezioni online individuali su italki.',
    ...
    atmTipTitle: '💡 Consiglio importante per expat:',
    atmTipDesc: 'Scegli sempre di essere addebitato in Euro (€) se l’ATM offre la conversione nella tua valuta di origine.',
    ...
    perksSectionTitle: '🔥 Offerte e vantaggi esclusivi',
    perksSectionSub: 'Risparmia tempo e denaro con i nostri partner ufficiali utilizzando i tuoi vantaggi PortuStart:',
    claimDealBtn: 'Richiedi offerta ↗',

    perk1Title: 'Conto Expat Revolut',
    perk1Badge: 'Finanza • Senza commissioni',
    perk1Desc: '• Zero commissioni di cambio valuta estera\n• Include carta Visa fisica\n• Perfetto per affitto e stipendio in PT',

    perk2Title: 'e-Residence NIF Express',
    perk2Badge: 'Governo • Consegna in 48h',
    perk2Desc: '• Nessun viaggio fisico alle Finanças necessario\n• 100% digitale e legalmente vincolante\n• Include firma digitale sicura',

    perk3Title: 'Lezioni di lingua italki',
    perk3Badge: 'Lingue • 1 a 1',
    perk3Desc: '• Tutor madrelingua certificati di portoghese\n• Programmazione online flessibile\n• Ideale per la comunicazione quotidiana e ufficiale',

    congratsTitle: '🎉 Congratulazioni!',
    congratsDesc: 'Hai completato con successo tutti i 7 passaggi della tua tabella di marcia! Sei pronto per il tuo perfetto nuovo inizio in Portogallo.',
    ...
    servicesTitle: '📄 Servizi di trasferimento ufficiali',
    servicesSub: 'Richiedi documenti essenziali e copertura al 100% online tramite il nostro partner e-Residence:',
    checklistTitle: '📋 Tabella di marcia dei primi 30 giorni',
    checklistSub: 'La tua checklist di trasferimento passo dopo passo',
    checklistDone: 'completato',
    applyOnlineBtn: 'Richiedi online ora ↗',
    affiliateDisclosure: 'Avviso di trasparenza: Questi link indirizzano a un’elaborazione espressa certificata con e-Residence. Riceviamo una piccola commissione di segnalazione senza costi aggiuntivi per te.',
    affiliateCards: [
      { key: 'nif', title: 'NIF (Codice fiscale portoghese)', badge: 'Passo 1 • Essenziale', desc: 'La chiave principale per affitti, schede SIM, lavoro e conti bancari.', link: AFFILIATE_LINKS.eResidenceNif, icon: 'document-text' },
      { key: 'bank', title: 'Conto bancario portoghese', badge: 'Passo 2 • IBAN', desc: 'Apri un conto bancario locale conforme con IBAN portoghese.', link: AFFILIATE_LINKS.eResidenceBank, icon: 'card' },
      { key: 'niss', title: 'NISS (Numero di previdenza sociale)', badge: 'Passo 3 • Lavoro', desc: 'Obbligatorio per l’elaborazione delle buste paga e contratti di lavoro.', link: AFFILIATE_LINKS.eResidenceNiss, icon: 'shield-checkmark' },
      { key: 'health', title: 'Assicurazione sanitaria internazionale', badge: 'Passo 4 • Visto e cure', desc: 'Copertura sanitaria conforme richiesta per i visti nomadi D7/D8.', link: AFFILIATE_LINKS.eResidenceHealth, icon: 'medkit' },
    ],
    ...
    calc14Notice: 'Basato su 14 mensilità standard all’anno',
    calcGrossRow: 'Lordo mensile:',
    calcSSRow: 'Sicurezza sociale (-11%):',
    calcIRSRow: 'Trattenuta IRS:',
    checklist: [
      { id: 1, title: 'Ottieni il tuo codice fiscale (NIF)', tip: 'La chiave principale per affitto, scheda SIM, lavoro e utenze.' },
      { id: 2, title: 'Procurati una scheda SIM portoghese locale', tip: 'Essenziale per l’autenticazione digitale statale (Chave Móvel).' },
      { id: 3, title: 'Apri un conto bancario portoghese', tip: 'Richiesto per l’accredito dello stipendio e i depositi cauzionali.' },
      { id: 4, title: 'Stipula un’assicurazione sanitaria expat', tip: 'Essenziale per la richiesta del visto e cure mediche pre-SNS.' },
      { id: 5, title: 'Ottieni il numero di previdenza sociale (NISS)', tip: 'Obbligatorio per contributi lavorativi e previdenziali.' },
      { id: 6, title: 'Registrazione della residenza (CRUE / AIMA)', tip: 'I cittadini UE si registrano presso il municipio (Câmara) dopo 3 mesi.' },
      { id: 7, title: 'Ottieni il tuo numero sanitario SNS', tip: 'Garantisce l’accesso alle cliniche di assistenza sanitaria primaria (Centro de Saúde).' },
    ],
    cities: [
      {
        id: 'lisboa',
        ...
        places: [
          { id: 'l1', title: 'Torre di Belém e Monastero dos Jerónimos', category: 'Patrimonio Mondiale UNESCO', desc: 'Capolavoro manuelino lungo il fiume Tago.', tip: 'Consiglio: Arrivare prima delle 10:00.' },
          { id: 'l2', title: 'Miradouro de Santa Luzia', category: 'Belvedere', desc: 'Bougainvillea con vista sui tetti di terracotta.', tip: 'Consiglio: Visita al tramonto.' },
          { id: 'l3', title: 'Praça do Comércio', category: 'Piazza storica', desc: 'Grande piazza porticata affacciata sul fiume.', tip: 'Consiglio: Ottimo punto di partenza per passeggiate.' },
          { id: 'lb1', title: 'Spiaggia di Carcavelos', category: '🏖 Spiaggia urbana e da surf', desc: 'La spiaggia più grande sulla linea ferroviaria di Cascais.', tip: 'Consiglio: 25 min di treno da Cais do Sodré.' },
          { id: 'lb2', title: 'Spiaggia di Galapinhos', category: '🏖 Natura di Arrábida', desc: 'Acque cristalline sotto le scogliere del parco naturale.', tip: 'Consiglio: Arrivare presto in estate.' },
        ],
      },
      {
        id: 'porto',
        name: 'Porto',
        tagline: 'Architettura in granito, vino Porto e ponti spettacolari',
        places: [
          { id: 'p1', title: 'Ponte Dom Luís I e Ribeira', category: 'Monumento', desc: 'Iconico ponte in ferro a due livelli sul fiume Douro.', tip: 'Consiglio: Percorri il livello superiore a piedi.' },
          { id: 'p2', title: 'Libreria Lello', category: 'Architettura', desc: 'Celebre libreria neogotica con scala rossa.', tip: 'Consiglio: Prenota i biglietti online.' },
          { id: 'p3', title: 'Cantine di vino Porto a Gaia', category: 'Degustazione e tradizione', desc: 'Cantine secolari con barche tradizionali.', tip: 'Consiglio: Prenota una degustazione guidata.' },
          { id: 'pb1', title: 'Spiaggia di Matosinhos', category: '🏖 Spiaggia con metro', desc: 'Ampia spiaggia al capolinea della metro, famosa per il pesce fresco.', tip: 'Consiglio: Prova il branzino alla griglia.' },
          { id: 'pb2', title: 'Spiaggia di Miramar', category: '🏖 Cappella sull’oceano', desc: 'Cappella del XVII secolo arroccata sugli scogli.', tip: 'Consiglio: Splendido punto fotografico al tramonto.' },
        ],
      },
      {
        id: 'sintra',
        name: 'Sintra e Cascais',
        tagline: 'Palazzi da fiaba nelle foreste nebbiose e scogliere oceaniche',
        places: [
          { id: 's1', title: 'Palazzo Nazionale di Pena', category: 'Palazzo romantico', desc: 'Castello colorato sulle cime più alte di Sintra.', tip: 'Consiglio: Prenota le fasce orarie mattutine.' },
          ...
          { id: 'sb1', title: 'Spiaggia di Guincho', category: '🏖 Dune e surf selvaggio', desc: 'Paradiso del surf di fama mondiale incorniciato dalle dune.', tip: 'Consiglio: Usa le passerelle di legno.' },
          { id: 'sb2', title: 'Spiaggia di Ursa', category: '🏖 Caletta segreta', desc: 'Spiaggia selvaggia isolata circondata da imponenti faraglioni.', tip: 'Consiglio: Indossa scarpe da trekking.' },
        ],
      },
      {
        id: 'algarve',
        name: 'Faro e Algarve',
        tagline: 'Scogliere dorate e 300 giorni di sole all’anno',
        places: [
          { id: 'a1', title: 'Grotta marina di Benagil', category: 'Grotte e spiagge', desc: 'La più famosa grotta-cattedrale marina d’Europa.', tip: 'Consiglio: Noleggia un kayak la mattina presto.' },
          { id: 'a2', title: 'Ponta da Piedade (Lagos)', category: 'Costa rocciosa', desc: 'Archi di pietra calcarea e acque turchesi cristalline.', tip: 'Consiglio: Fai un tour in piccola barca.' },
          { id: 'a3', title: 'Parco Naturale di Ria Formosa', category: 'Laguna e isole', desc: 'Area umida costiera protetta con isole senza auto.', tip: 'Consiglio: Prendi il traghetto per Armona.' },
          { id: 'ab1', title: 'Spiaggia di Marinha', category: '🏖 Top spiaggia europea', desc: 'Archi marini doppi iconici e acque per snorkeling.', tip: 'Consiglio: Sentiero delle Sette Valli Sospese.' },
          { id: 'ab2', title: 'Spiaggia di Falesia', category: '🏖 Scogliere rosse', desc: 'Oltre 6 km di sabbia protetti da scogliere di arenaria rossa.', tip: 'Consiglio: Passeggiate con la bassa marea.' },
        ],
      },
      {
        id: 'coimbra',
        ...
        places: [
          { id: 'c1', title: 'Biblioteca Joanina', category: 'Biblioteca barocca', desc: 'Biblioteca dorata che custodisce manoscritti rari.', tip: 'Consiglio: Prenota biglietti combinati.' },
          { id: 'c2', title: 'Monastero di Santa Cruz', category: 'Storia e fado', desc: 'Luogo di riposo dei primi re del Portogallo.', tip: 'Consiglio: Ascolta un concerto di fado serale.' },
          { id: 'cb1', title: 'Spiaggia di Claridade (Figueira)', category: '🏖 Vasta spiaggia di sabbia', desc: 'Enorme distesa sabbiosa dotata di passerelle.', tip: 'Consiglio: 40 min di treno da Coimbra.' },
          { id: 'cb2', title: 'Spiaggia di Mira', category: '🏖 Pesca tradizionale', desc: 'Pittoresca spiaggia con casette di legno a righe.', tip: 'Consiglio: Assaggia i calamari fritti.' },
        ],
      },
      {
        id: 'madeira',
        name: 'Madera (Funchal)',
        tagline: 'L’isola dei fiori con cime frastagliate e levadas lussureggianti',
        places: [
          { id: 'm1', title: 'Da Pico do Arieiro a Pico Ruivo', category: 'Sentiero alpino', desc: 'Traversata di cresta montana sopra la linea delle nuvole.', tip: 'Consiglio: Parti per l’alba.' },
          { id: 'm2', title: 'Sentiero Levada das 25 Fontes', category: 'Natura UNESCO', desc: 'Sentiero lungo canali storici nella foresta dialloro.', tip: 'Consiglio: Inizia presto la mattina.' },
          { id: 'mb1', title: 'Prainha do Caniçal', category: '🏖 Spiaggia di sabbia nera', desc: 'Caratteristica caletta naturale di sabbia vulcanica scura.', tip: 'Consiglio: Splendido contrasto cromatico.' },
          { id: 'mb2', title: 'Spiaggia di Calheta', category: '🏖 Laguna dorata', desc: 'Doppia spiaggia protetta con acque calme e calde.', tip: 'Consiglio: Ideale per le famiglie.' },
        ],
      },
    ],
  },
  uk: {
    ...
    tabTrans: 'Перекладач',
    tabCalc: 'Зарплата',
    placesSectionTitle: '🇵🇹 Інтерактивна карта та визначні місця',
    placesSectionSub: 'Жива карта Португалії – виберіть регіон або забронюйте тур:',
    openInAppMaps: 'Відкрити в Картах',
    swipeInstruction: '👉 Гортайте горизонтально для перегляду місць, пляжів і турів:',
    openInMapsBtn: 'Маршрут',
    gygBtn: 'Квитки та тури (GetYourGuide) ↗',
    italkiBannerTitle: '🗣 Вивчайте португальську мову вільно',
    italkiBannerDesc: 'Знайдіть сертифікованих носіїв мови для індивідуальних онлайн-уроків на italki.',
    italkiBtn: 'Знайти репетиторів (italki) ↗',
    
    atmSectionTitle: '🏧 Банкомати без комісії (Multibanco)',
    atmSectionSub: 'Використовуйте офіційну мережу Multibanco у відділеннях банків для зняття готівки з картками Revolut чи Wise без додаткових зборів:',
    atmTipTitle: '💡 Важлива порада для емігрантів:',
    atmTipDesc: 'Завжди обирайте списання в євро (€), якщо банкомат пропонує конвертацію у вашу рідну валюту.',

    docSectionTitle: '🩺 Англомовні лікарі та екстрена допомога',
    docSectionSub: 'Основні номери екстрених служб та приватні медичні центри з підтримкою іноземних пацієнтів:',
    callDoctorBtn: 'Зателефонувати',
    directionBtn: 'Відкрити локацію',
    emergencyTitle: '🚨 Екстрені та довідкові контакти',

    perksSectionTitle: '🔥 Ексклюзивні пропозиції для емігрантів',
    perksSectionSub: 'Заощаджуйте час і гроші з нашими офіційними партнерами, використовуючи переваги PortuStart:',
    claimDealBtn: 'Отримати знижку ↗',

    perk1Title: 'Рахунок Revolut Expat',
    perk1Badge: 'Фінанси • Без комісії',
    perk1Desc: '• Нульова комісія за закордонні транзакції\n• Фізична картка Visa в комплекті\n• Ідеально для оренди та зарплати в PT',

    perk2Title: 'e-Residence NIF Express',
    perk2Badge: 'Держпослуги • Доставка за 48 годин',
    perk2Desc: '• Без особистих візитів до Finanças\n• 100% цифровий та юридично чинний процес\n• Включає безпечний цифровий підпис',

    perk3Title: 'Мовні курси italki',
    perk3Badge: 'Мови • 1 на 1',
    perk3Desc: '• Сертифіковані репетитори-носії мови\n• Гнучкий онлайн-графік\n• Ідеально для побутового та офіційного спілкування',

    congratsTitle: '🎉 Вітаємо!',
    congratsDesc: 'Ви успішно виконали всі 7 кроків дорожньої карти! Ви готові до ідеального початку нового життя в Португалії.',
    ...
    speakBtn: 'Голосове введення (STT)',
    resultLabel: 'Результат',
    servicesTitle: '📄 Офіційні послуги з переїзду',
    servicesSub: 'Замовляйте необхідні документи та страховку 100% онлайн через нашого партнера e-Residence:',
    checklistTitle: '📋 План на перші 30 днів',
    checklistSub: 'Ваш покроковий чек-лист релокації',
    checklistDone: 'виконано',
    applyOnlineBtn: 'Подати заявку онлайн ↗',
    affiliateDisclosure: 'Повідомлення про прозорість: Ці посилання ведуть до сертифікованого експрес-оформлення через e-Residence. Ми отримуємо невелику комісію без додаткових витрат для вас.',
    affiliateCards: [
      { key: 'nif', title: 'NIF (Португальський податковий номер)', badge: 'Крок 1 • Обов’язково', desc: 'Головний ключ для оренди, SIM-карт, роботи та банківського рахунку.', link: AFFILIATE_LINKS.eResidenceNif, icon: 'document-text' },
      { key: 'bank', title: 'Португальський банківський рахунок', badge: 'Крок 2 • IBAN', desc: 'Відкрийте повноцінний місцевий рахунок з португальським IBAN.', link: AFFILIATE_LINKS.eResidenceBank, icon: 'card' },
      { key: 'niss', title: 'NISS (Номер соціального страхування)', badge: 'Крок 3 • Працевлаштування', desc: 'Обов’язково для нарахування зарплати та трудових договорів.', link: AFFILIATE_LINKS.eResidenceNiss, icon: 'shield-checkmark' },
      { key: 'health', title: 'Міжнародне медичне страхування', badge: 'Крок 4 • Віза та захист', desc: 'Медичне покриття, необхідне для віз цифрових кочівників D7/D8.', link: AFFILIATE_LINKS.eResidenceHealth, icon: 'medkit' },
    ],
    calcTitle: '💶 Калькулятор чистої зарплати',
    calcSub: 'Одинаків без дітей, материкова Португалія (14 виплат).',
    calcGrossLabel: 'Місячна брутто-зарплата (€):',
    calcBtn: 'Розрахувати',
    calcNetMonthly: 'Орієнтовний чистий дохід (місяць):',
    calc14Notice: 'На основі стандартних 14 виплат на рік',
    calcGrossRow: 'Брутто на місяць:',
    calcSSRow: 'Соціальне страхування (-11%):',
    calcIRSRow: 'Податок IRS:',
    checklist: [
      { id: 1, title: 'Отримати податковий номер (NIF)', tip: 'Головний ключ для оренди житла, SIM-карти, роботи та комунальних послуг.' },
      { id: 2, title: 'Придбати місцеву португальську SIM-карту', tip: 'Необхідно для державного цифрового входу (Chave Móvel).' },
      { id: 3, title: 'Відкрити португальський банківський рахунок', tip: 'Потрібно для отримання зарплати та застави за оренду.' },
      { id: 4, title: 'Оформити медичне страхування для емігрантів', tip: 'Необхідно для оформлення візи та доступу до медицини до отримання SNS.' },
      { id: 5, title: 'Отримати номер соціального страхування (NISS)', tip: 'Обов’язково для податків, пенсійних відрахувань та контрактів.' },
      { id: 6, title: 'Реєстрація резиденції (CRUE / AIMA)', tip: 'Громадяни ЄС реєструються в місцевій мерії (Câmara) після 3 місяців.' },
      { id: 7, title: 'Отримати медичний номер SNS', tip: 'Надає доступ до державних поліклінік (Centro de Saúde).' },
    ],
    cities: [
      {
        id: 'lisboa',
        name: 'Лісабон',
        tagline: 'Місто 7 пагорбів, фаду та оглядових майданчиків',
        places: [
          { id: 'l1', title: 'Торре-ді-Белен та Монастир єронімітів', category: 'Світова спадщина ЮНЕСКО', desc: 'Шедевр мануеліно вздовж річки Тежу.', tip: 'Порада: Приходьте до 10:00 ранку.' },
          { id: 'l2', title: 'Оглядовий майданчик Санта-Лузія', category: 'Оглядовий майданчик', desc: 'Квіти бугенвілеї з видом на черепичні дахи.', tip: 'Порада: Відвідайте під час заходу сонця.' },
          { id: 'l3', title: 'Площа Коммерсіu', category: 'Історична площа', desc: 'Велична річкова площа з аркадами.', tip: 'Порада: Чудова початкова точка для прогулянок.' },
          { id: 'lb1', title: 'Пляж Каркавелуш', category: '🏖 Міський та серфінг-пляж', desc: 'Найбільший пляж на залізничній гілці Кашкайш.', tip: 'Порада: 25 хв потягом від Cais do Sodré.' },
          { id: 'lb2', title: 'Пляж Галапіньюш', category: '🏖 Природа Аррабіди', desc: 'Кристально чиста вода серед скель заповідника.', tip: 'Порада: Приїжджайте вранці влітку.' },
        ],
      },
      {
        id: 'porto',
        ...
        places: [
          { id: 'p1', title: 'Міст дона Луїша I та Рібейра', category: 'Визначна пам’ятка', desc: 'Знаковий двоярусний арочний міст над Доуро.', tip: 'Порада: Пройдіться верхнім ярусом пішки.' },
          { id: 'p2', title: 'Книгарня Леллу', category: 'Архітектура', desc: 'Всесвітньо відома неоготична книгарня з червоними сходами.', tip: 'Порада: Замовляйте квитки онлайн.' },
          { id: 'p3', title: 'Підвали портвейну у Гаї', category: 'Дегустація та спадщина', desc: 'Столітні погреби витримки з традиційними човнами.', tip: 'Порада: Замовте дегустацію з гідом.' },
          { id: 'pb1', title: 'Пляж Матозіньюш', category: '🏖 Пляж біля метро', desc: 'Широкий пляж на кінцевій зупинці метро, відомий морепродуктами.', tip: 'Порада: Спробуйте смаженого сібаса.' },
          { id: 'pb2', title: 'Пляж Мірамар', category: '🏖 Каплиця в океані', desc: 'Каплиця XVII століття на скелях серед хвиль.', tip: 'Порада: Чудове місце для фото заходу сонця.' },
        ],
      },
      {
        id: 'sintra',
        name: 'Сінтра та Кашкайш',
        tagline: 'Казкові палаци у туманних лісах та скелі океану',
        places: [
          { id: 's1', title: 'Національний палац Пена', category: 'Романтичний палац', desc: 'Барвистий жовто-червоний замок на вершинах Сіnтри.', tip: 'Порада: Замовляйте ранкові слоти.' },
          { id: 's2', title: 'Кінта-да-Регалейра', category: 'Містичний маєток', desc: 'Зачарований парк із гротами та колодязем посвяти.', tip: 'Порада: Візьміть із собою ліхтарик.' },
          { id: 's3', title: 'Мис Рока', category: 'Природне диво', desc: 'Найзахідніша точка континентальної Європи.', tip: 'Порада: Візьміть вітровку.' },
          { id: 'sb1', title: 'Пляж Гіншу', category: '🏖 Дикі дюни для серфінгу', desc: 'Всесвітньо відомий рай для серфінгу серед дюн.', tip: 'Порада: Пройдіться дерев’яним настилом.' },
          { id: 'sb2', title: 'Пляж Урса', category: '🏖 Секретна бухта', desc: 'Відокремлений дикий пляж біля велетенських скель.', tip: 'Порада: Одягайте трекінгове взуття.' },
        ],
      },
      {
        id: 'algarve',
        ...
        places: [
          { id: 'a1', title: 'Морська печера Бенагіл', category: 'Печери та пляжі', desc: 'Найвідоміша морська печера-собор Європи.', tip: 'Порада: Орендуйте байдарку ранку.' },
          { id: 'a2', title: "Понта-да-П'єдаде (Лагош)", category: 'Скелястий берег', desc: 'Вапнякові арки та бірюзова вода.', tip: 'Порада: Зробіть тур на човні.' },
          { id: 'a3', title: 'Природний парк Ріа-Формоза', category: 'Лагуна та острови', desc: 'Захищені прибережні водно-болотні угіддя без машин.', tip: 'Порада: Пором на острів Армона.' },
          { id: 'ab1', title: 'Пляж Марінья', category: '🏖 Найкращий пляж Європи', desc: 'Знакові подвійні арки та прозора вода.', tip: 'Порада: Стежка Семи Висячих Долин.' },
          { id: 'ab2', title: 'Пляж Фалезія', category: '🏖 Червоні скелі', desc: 'Понад 6 км піску під червоними стрімкими скелями.', tip: 'Порада: Прогулянки під час відливу.' },
        ],
      },
      {
        id: 'coimbra',
        name: 'Коїмбра та Центр',
        tagline: 'Стародавня королівська столиця та університетська історія',
        places: [
          { id: 'c1', title: 'Бібліотека Жуаніна', category: 'Барокова бібліотека', desc: 'Позолочена бібліотека рідкісних рукописів.', tip: 'Порада: Купуйте комбіновані квитки.' },
          { id: 'c2', title: 'Монастир Санта-Круш', category: 'Історія та фаду', desc: 'Місце спочинку перших королів Португалії.', tip: 'Порада: Відвідайте вечірній концерт фаду.' },
          { id: 'cb1', title: 'Пляж Кларідаде (Фігейра)', category: '🏖 Величезний пляж', desc: 'Величезна піщана смуга з дерев’яними доріжками.', tip: 'Порада: 40 хв потягом.' },
          { id: 'cb2', title: 'Пляж Міра', category: '🏖 Традиційна риболовля', desc: 'Мальовничий пляж із кольоровими дерев’яними хатинами.', tip: 'Порада: Спробуйте смажені кальмари.' },
        ],
      },
      {
        id: 'madeira',
        name: 'Мадейра (Фуншал)',
        tagline: 'Острів квітів із гострими піками та зелентими левадами',
        places: [
          { id: 'm1', title: 'Від Піку-ду-Арейру до Піку-Руіву', category: 'Альпійський маршрут', desc: 'Гірський хребет над хмарами.', tip: 'Порада: Вирушайте на світанку.' },
          { id: 'm2', title: 'Стежка 25 Фонтанів', category: 'Природа ЮНЕСКО', desc: 'Маршрут вздовж старовинних каналів у лавровому лісі.', tip: 'Порада: Починайте раніше.' },
          { id: 'mb1', title: 'Прайнья-ду-Канісал', category: '🏖 Чорний вулканічний пісок', desc: 'Затишна природна бухта з темним піском.', tip: 'Порада: Чудовий контраст кольорів.' },
          { id: 'mb2', title: 'Пляж Кальєта', category: '🏖 Золота лагуна', desc: 'Захищений подвійний пляж зі спокійною теплою водою.', tip: 'Порада: Чудово підходить для сімей.' },
        ],
      },
    ],
  },
